...
const Blogs = () => {
  return (
    <Container>
      <div className="blogsContaier">
        <div className="blogsColumn">
          ...
          <p>
            ...
            information provided or entered by the user.It is the first step of
            a good identity and access management process.is visible to and
            partially changeable by the user. On the other side ,
            <strong>Authorization </strong>
            determines what resources a user can access.It works through
            settings that are implemented and maintained by the organization.It
            always takes place after authentication.It isn't visible to or
        ...
        <div className="blogsColumn">
          ...
          <p>
            ...
            application development platform that allows developers to create
            iOS, Android, and Web apps. It offers many features to easily work
            with backend development tool for web and mobile apps.It also offers
            active backend as a service for building dynamic web and mobile
            apps. When a client-side app build with JavaScript or any of its
            frameworks,Firebase turn that app into a serverless app in no time.
            It also removes the need of managing databases. With Firebase, it's
            pretty simple to connect and use built-in third-party authentication
            providers, including Google, Facebook, Twitter, among others. And
            also very easy to use a pre-built authentication UI, Firebase saves
            a significant amount of development cost. Firebase is a good choice
            to deploy a working product on the cloud.
            <strong>
        ...
        <div className="blogsColumn">
          ...
          <p>
            ...
            <strong>Dynamic Links</strong> is majorly used to generate deep
            links that redirect user traffic to your landing page, website, or
            mobile applications. They also provide custom domain names,
